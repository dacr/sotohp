      ...
      <div className="viewer">
        ...
        <div className="sidebar">
          ...
          <div className="info">
            ...
            {media?.autoDescription?.trim() && (
              <div>
                <strong title="Generated by the local image-to-text model">Auto description:</strong>{" "}
                <span style={{ fontStyle: "italic", color: "#4b5563" }} title={media.autoDescription}>
                  {media.autoDescription.trim()}
                </span>
              </div>
            )}
